...
public interface IResponse {
     ...
     * @return 系统异常响应
     */
    IResponse failure(String errCode, String msg);
     ...
     * @return 系统异常响应
     */
    IResponse failure(ResponseCodeEnum responseCode);
     ...
     * @return 系统异常响应
     */
    IResponse failure(ResponseCodeEnum responseCode, String msg);
